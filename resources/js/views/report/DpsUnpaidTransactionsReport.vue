        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-title">
                        <h4>DPS Unpaid Transaction Report</h4>
                    </div>
...
export default ({
    ...
    data () {
        return {
            dps_unpaid_transaction_data: null,
    ...
    computed: {
        ...mapGetters({
            transactions: 'report/dps_unpaid_transactions',
    ...
    methods: {
        ...mapActions({
            getDpsTransactions: 'report/getDpsUnpaidTransactions',
            filterDpsTransactions: 'report/filterDpsUnpaidTransactions'
        }),
        ...
        downloadReport() {
            ...
            window.open(`${window.location.origin}/download/dps/transactions/unpaid${filterQuery}`);
        },
