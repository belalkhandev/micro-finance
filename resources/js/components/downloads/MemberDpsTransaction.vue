<template>
    <div class="modal fade" id="downloadDpsTransactions">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Download DPS Transactions</h5>
                ...
                <div class="modal-footer text-right">
                    <a :href="'/download/dps/'+member_id+'/transactions?from_date='+form.from_date+'&to_date='+form.to_date" class="btn btn-success" target="_blank">
