<template>
    <div class="modal fade" id="downloadLoanTransactions">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Download Loan Transactions</h5>
                ...
                <div class="modal-footer text-right">
                    <a :href="'/download/loan/'+member_id+'/transactions?from_date='+form.from_date+'&to_date='+form.to_date" class="btn btn-success" target="_blank">
