<template>
    <div class="main-header">
        ...
        <div>
            <button type="button" class="mr-2 btn btn-outline-warning py-0 px-1 focus:shadow-none hover:text-white" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="bx bx-search-alt"></i> <span class="text-warning">Search member</span></button>
